...
## Project Structure
    ...
    ├── herringtonbrothersf_33299  # Django project configurations
...
1. Clone this repo and `cd herringtonbrothersf_33299`
...
2. Clone this repo and `cd herringtonbrothersf_33299`
